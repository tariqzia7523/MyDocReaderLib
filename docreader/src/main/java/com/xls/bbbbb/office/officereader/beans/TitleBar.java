...
{   
    public TitleBar(Context context)
    {
        ...
        BitmapFactory.decodeResource(getResources(),  R.drawable.document_title_background_for_vertical, opts);
        height = opts.outHeight;        

        setBackgroundResource(R.drawable.document_title_background_for_vertical);
