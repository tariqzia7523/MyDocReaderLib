...
import com.xls.bbbbb.office.fc.hslf.blip.Metafile;
import com.xls.bbbbb.office.fc.hslf.exceptions.CorruptPowerPointFileException;
import com.xls.bbbbb.office.fc.hslf.exceptions.EncryptedPowerPointFileException;
...
import com.xls.bbbbb.office.fc.hslf.record.PersistRecord;
import com.xls.bbbbb.office.fc.hslf.record.Record;
import com.xls.bbbbb.office.fc.hslf.record.UserEditAtom;
import com.xls.bbbbb.office.fc.hslf.usermodel.ObjectData;
...
//                                out.write(pict.getData());
    ...
    /*public void write(OutputStream out, boolean preserveNodes) throws IOException
    {
        ...
        // Update our cached copyFile of the bytes that make up the PPT stream
