...
import com.xls.bbbbb.office.fc.hssf.record.AutoFilterInfoRecord;
...
import com.xls.bbbbb.office.fc.hssf.record.aggregates.FormulaRecordAggregate;
...
import com.xls.bbbbb.office.fc.hssf.util.Region;
import com.xls.bbbbb.office.fc.ss.SpreadsheetVersion;
import com.xls.bbbbb.office.fc.ss.usermodel.CellRange;
import com.xls.bbbbb.office.fc.ss.usermodel.DataValidation;
import com.xls.bbbbb.office.fc.ss.usermodel.DataValidationHelper;
import com.xls.bbbbb.office.fc.ss.usermodel.ICell;
import com.xls.bbbbb.office.fc.ss.usermodel.ICellStyle;
...
import com.xls.bbbbb.office.fc.ss.util.SSCellRange;
import com.xls.bbbbb.office.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements com.xls.bbbbb.office.fc.ss.usermodel.Sheet
{
     ...
     * @see HSSFRow
     * @see #removeRow(com.com.xls.bbbbb.office.fc.ss.usermodel.IRow)
     */
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(com.xls.bbbbb.office.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link com.xls.bbbbb.office.fc.ss.usermodel.com.xls.bbbbb.office.fc.ss.usermodel.FormulaEvaluator} is the
     ...
     *  {@link com.xls.bbbbb.office.ss.model.baseModel.com.xls.bbbbb.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)}
     ...
     *
     * @see com.xls.bbbbb.office.ss.model.baseModel.com.xls.bbbbb.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)
     */
     ...
     * @param endRow the row to end shifting
     * @param n the number of rows to shift
     * @param copyRowHeight whether to copyFile the row height during the shift
