...
import com.xls.bbbbb.office.fc.POIDocument;
import com.xls.bbbbb.office.fc.codec.DigestUtils;
import com.xls.bbbbb.office.fc.ddf.EscherBSERecord;
import com.xls.bbbbb.office.fc.ddf.EscherBitmapBlip;
import com.xls.bbbbb.office.fc.ddf.EscherBlipRecord;
import com.xls.bbbbb.office.fc.ddf.EscherRecord;
import com.xls.bbbbb.office.fc.hssf.OldExcelFormatException;
...
import com.xls.bbbbb.office.fc.hssf.formula.ptg.MemFuncPtg;
import com.xls.bbbbb.office.fc.hssf.formula.ptg.Ptg;
import com.xls.bbbbb.office.fc.hssf.formula.ptg.UnionPtg;
import com.xls.bbbbb.office.fc.hssf.formula.udf.AggregatingUDFFinder;
import com.xls.bbbbb.office.fc.hssf.formula.udf.UDFFinder;
import com.xls.bbbbb.office.fc.hssf.model.DrawingManager2;
...
import com.xls.bbbbb.office.fc.hssf.record.AbstractEscherHolderRecord;
import com.xls.bbbbb.office.fc.hssf.record.BackupRecord;
import com.xls.bbbbb.office.fc.hssf.record.DrawingGroupRecord;
import com.xls.bbbbb.office.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import com.xls.bbbbb.office.fc.hssf.record.SubRecord;
...
import com.xls.bbbbb.office.fc.hssf.util.CellReference;
...
import com.xls.bbbbb.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.xls.bbbbb.office.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements com.xls.bbbbb.office.fc.ss.usermodel.Workbook
{
...
//            names.add(name);
     ...
     */
    public int getSheetIndex(com.xls.bbbbb.office.fc.ss.usermodel.Sheet sheet)
    {
...
//            sheetIndex));
        ...
        int endRow)
    {
        ...
        //using absolute references because they don't get copyProcess and pasted anyway
...
//        return newName;
     ...
     * @see com.xls.bbbbb.office.fc.hssf.record.FormatRecord
     * @see Record
     */
