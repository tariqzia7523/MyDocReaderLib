...
package com.xls.bbbbb.office.java.awt.geom;
...
public class AffineTransform implements Cloneable, java.io.Serializable
{
     ...
     * coordinates only need to be copyProcess to their destinations to
    ...
    /**
     * Constructs a new <code>AffineTransform</code> that is a copyFile of
     * the specified <code>AffineTransform</code> object.
     * @param Tx the <code>AffineTransform</code> object to copyFile
     * @since 1.2
     */
    ...
    /**
     * Sets this transform to a copyFile of the transform in the specified
     * <code>AffineTransform</code> object.
     * @param Tx the <code>AffineTransform</code> object from which to
     * copyFile the transform
     * @since 1.2
     */
    ...
    public void transform(float[] srcPts, int srcOff, float[] dstPts, int dstOff, int numPts)
    {
        ...
        if (dstPts == srcPts && dstOff > srcOff && dstOff < srcOff + numPts * 2)
        {
            ...
            // To get around this we use arraycopy to copyFile the points
    ...
    /**
     * Returns a copyFile of this <code>AffineTransform</code> object.
     * @return an <code>Object</code> that is a copyFile of this
     * <code>AffineTransform</code> object.
     * @since 1.2
     */
    public Object clone()
