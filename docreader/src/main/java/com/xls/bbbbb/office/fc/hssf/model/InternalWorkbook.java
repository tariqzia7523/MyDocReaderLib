...
import com.xls.bbbbb.office.fc.ddf.EscherBSERecord;
...
import com.xls.bbbbb.office.fc.ddf.EscherRGBProperty;
...
import com.xls.bbbbb.office.fc.ddf.EscherSplitMenuColorsRecord;
import com.xls.bbbbb.office.fc.hssf.formula.EvaluationWorkbook.ExternalName;
import com.xls.bbbbb.office.fc.hssf.formula.EvaluationWorkbook.ExternalSheet;
import com.xls.bbbbb.office.fc.hssf.formula.FormulaShifter;
import com.xls.bbbbb.office.fc.hssf.formula.ptg.Area3DPtg;
import com.xls.bbbbb.office.fc.hssf.formula.ptg.NameXPtg;
import com.xls.bbbbb.office.fc.hssf.formula.ptg.OperandPtg;
import com.xls.bbbbb.office.fc.hssf.formula.ptg.Ptg;
import com.xls.bbbbb.office.fc.hssf.formula.ptg.Ref3DPtg;
import com.xls.bbbbb.office.fc.hssf.formula.udf.UDFFinder;
import com.xls.bbbbb.office.fc.hssf.record.BOFRecord;
import com.xls.bbbbb.office.fc.hssf.record.BackupRecord;
import com.xls.bbbbb.office.fc.hssf.record.BookBoolRecord;
import com.xls.bbbbb.office.fc.hssf.record.BoundSheetRecord;
import com.xls.bbbbb.office.fc.hssf.record.CodepageRecord;
import com.xls.bbbbb.office.fc.hssf.record.CountryRecord;
import com.xls.bbbbb.office.fc.hssf.record.DSFRecord;
import com.xls.bbbbb.office.fc.hssf.record.DateWindow1904Record;
import com.xls.bbbbb.office.fc.hssf.record.DrawingGroupRecord;
import com.xls.bbbbb.office.fc.hssf.record.EOFRecord;
import com.xls.bbbbb.office.fc.hssf.record.EscherAggregate;
import com.xls.bbbbb.office.fc.hssf.record.ExtSSTRecord;
import com.xls.bbbbb.office.fc.hssf.record.ExtendedFormatRecord;
import com.xls.bbbbb.office.fc.hssf.record.ExternSheetRecord;
import com.xls.bbbbb.office.fc.hssf.record.FileSharingRecord;
import com.xls.bbbbb.office.fc.hssf.record.FnGroupCountRecord;
import com.xls.bbbbb.office.fc.hssf.record.FontRecord;
import com.xls.bbbbb.office.fc.hssf.record.FormatRecord;
import com.xls.bbbbb.office.fc.hssf.record.HideObjRecord;
import com.xls.bbbbb.office.fc.hssf.record.HyperlinkRecord;
import com.xls.bbbbb.office.fc.hssf.record.InterfaceEndRecord;
import com.xls.bbbbb.office.fc.hssf.record.InterfaceHdrRecord;
import com.xls.bbbbb.office.fc.hssf.record.MMSRecord;
import com.xls.bbbbb.office.fc.hssf.record.NameCommentRecord;
import com.xls.bbbbb.office.fc.hssf.record.NameRecord;
import com.xls.bbbbb.office.fc.hssf.record.PaletteRecord;
import com.xls.bbbbb.office.fc.hssf.record.PasswordRecord;
import com.xls.bbbbb.office.fc.hssf.record.PasswordRev4Record;
import com.xls.bbbbb.office.fc.hssf.record.PrecisionRecord;
import com.xls.bbbbb.office.fc.hssf.record.ProtectRecord;
import com.xls.bbbbb.office.fc.hssf.record.ProtectionRev4Record;
import com.xls.bbbbb.office.fc.hssf.record.RecalcIdRecord;
import com.xls.bbbbb.office.fc.hssf.record.Record;
import com.xls.bbbbb.office.fc.hssf.record.RefreshAllRecord;
import com.xls.bbbbb.office.fc.hssf.record.SSTRecord;
import com.xls.bbbbb.office.fc.hssf.record.StyleRecord;
import com.xls.bbbbb.office.fc.hssf.record.SupBookRecord;
import com.xls.bbbbb.office.fc.hssf.record.TabIdRecord;
import com.xls.bbbbb.office.fc.hssf.record.UnicodeString;
import com.xls.bbbbb.office.fc.hssf.record.UseSelFSRecord;
import com.xls.bbbbb.office.fc.hssf.record.WindowOneRecord;
import com.xls.bbbbb.office.fc.hssf.record.WindowProtectRecord;
import com.xls.bbbbb.office.fc.hssf.record.WriteAccessRecord;
import com.xls.bbbbb.office.fc.hssf.record.WriteProtectRecord;
import com.xls.bbbbb.office.fc.hssf.util.HSSFColor;
import com.xls.bbbbb.office.fc.ss.usermodel.BuiltinFormats;
 ...
 * @see com.xls.bbbbb.office.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
    ...
    */
    ...
    public NameRecord cloneFilter(int filterDbNameIndex, int newSheetIndex)
    {
        ...
        // copyFile original formula but adjust 3D refs to the new external sheet index
     ...
     *
     * @see com.xls.bbbbb.office.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
