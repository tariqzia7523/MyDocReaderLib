...
import com.xls.bbbbb.office.fc.hssf.record.CFRuleRecord;
import com.xls.bbbbb.office.fc.hssf.record.aggregates.CFRecordsAggregate;
...
import com.xls.bbbbb.office.fc.ss.usermodel.ConditionalFormatting;
import com.xls.bbbbb.office.fc.ss.usermodel.ConditionalFormattingRule;
import com.xls.bbbbb.office.fc.ss.usermodel.SheetConditionalFormatting;
import com.xls.bbbbb.office.fc.ss.util.HSSFCellRangeAddress;
import com.xls.bbbbb.office.fc.ss.util.Region;
...
//		return new HSSFConditionalFormattingRule(wb, rr);
	...
	/**
	 * Adds a copyFile of HSSFConditionalFormatting object to the sheet
	 * <p>This method could be used to copyFile HSSFConditionalFormatting object
