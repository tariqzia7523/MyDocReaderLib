 ...
 * 时间:              下午1:55:20
 */
package com.xls.bbbbb.office.ss.model.XLSModel;
...
import com.xls.bbbbb.office.common.shape.AChart;
...
import com.xls.bbbbb.office.fc.hssf.model.InternalSheet;
import com.xls.bbbbb.office.fc.hssf.model.InternalWorkbook;
import com.xls.bbbbb.office.fc.hssf.record.BlankRecord;
import com.xls.bbbbb.office.fc.hssf.record.CellValueRecordInterface;
import com.xls.bbbbb.office.fc.hssf.record.DefaultRowHeightRecord;
...
import com.xls.bbbbb.office.fc.hssf.record.RowRecord;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFAutoShape;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFChart;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFChildAnchor;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFClientAnchor;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFFreeform;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFLine;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFPatriarch;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFPicture;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFPictureData;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFRichTextString;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFShape;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFShapeGroup;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFSheet;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFTextbox;
import com.xls.bbbbb.office.fc.hssf.usermodel.HSSFWorkbook;
import com.xls.bbbbb.office.fc.hssf.util.HSSFPaneInformation;
import com.xls.bbbbb.office.fc.ss.util.HSSFCellRangeAddress;
import com.xls.bbbbb.office.fc.xls.ChartConverter;
import com.xls.bbbbb.office.java.awt.Rectangle;
import com.xls.bbbbb.office.ss.model.CellRangeAddress;
import com.xls.bbbbb.office.ss.model.baseModel.Cell;
import com.xls.bbbbb.office.ss.model.baseModel.Row;
import com.xls.bbbbb.office.ss.model.baseModel.Sheet;
import com.xls.bbbbb.office.ss.model.baseModel.Workbook;
import com.xls.bbbbb.office.ss.model.drawing.AnchorPoint;
import com.xls.bbbbb.office.ss.model.drawing.CellAnchor;
import com.xls.bbbbb.office.ss.model.sheetProperty.PaneInformation;
import com.xls.bbbbb.office.ss.util.ModelUtil;
import com.xls.bbbbb.office.ss.util.SectionElementFactory;
...
import com.xls.bbbbb.office.thirdpart.achartengine.chart.RoundChart;
import com.xls.bbbbb.office.thirdpart.achartengine.chart.XYChart;
import com.xls.bbbbb.office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.xls.bbbbb.office.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.xls.bbbbb.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.xls.bbbbb.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.xls.bbbbb.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.xls.bbbbb.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.xls.bbbbb.office.ss.model.sheetProperty.ColumnInfo(
