...
import com.xls.bbbbb.office.fc.hpsf.DocumentSummaryInformation;
import com.xls.bbbbb.office.fc.hpsf.MutablePropertySet;
import com.xls.bbbbb.office.fc.hpsf.PropertySet;
import com.xls.bbbbb.office.fc.hpsf.PropertySetFactory;
import com.xls.bbbbb.office.fc.hpsf.SummaryInformation;
...
import com.xls.bbbbb.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.xls.bbbbb.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.xls.bbbbb.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.xls.bbbbb.office.fc.hpsf.WritingNotSupportedException wnse)
        {
     ...
     * @param source is the source POIFS to copyFile from
     * @param target is the target POIFS to copyFile to
     * @param excepts is a list of Strings specifying what nodes NOT to copyFile
     */
    @ Deprecated
