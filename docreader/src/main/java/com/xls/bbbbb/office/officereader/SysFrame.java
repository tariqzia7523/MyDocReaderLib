...
//        setBackgroundResource(R.drawable.normal_background);
    ...
    private void initVertical(Resources res)
    {
        ...
        // 搜索
        BitmapFactory.decodeResource(res, R.drawable.search_icon, opts);
        AImageButton search = new AImageButton(context, control, "",  R.drawable.search_icon, -1, EventConstant.SYS_SEARCH_ID);
//        search.setPushBgResID(R.drawable.document_search_background_push);
...
//        BitmapFactory.decodeResource(context.getResources(),  R.drawable.document_background_vertical_button, opts);
...
//        BitmapFactory.decodeResource(context.getResources(), R.drawable.document_background_horizonal_button, opts);
