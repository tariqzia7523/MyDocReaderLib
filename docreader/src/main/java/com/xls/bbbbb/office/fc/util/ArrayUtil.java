...
public class ArrayUtil
{
    ...
    public static void arrayMoveWithin(Object[] array, int moveFrom, int moveTo, int numToMove) {
    	...
    	// And copyFile the shifted block to the shifted location
     ...
     * necessary) so the copyFile has the specified length. This method is temporary
     * replace for Arrays.copyOf() until we start to require JDK 1.6.
     * 
     * @param source
     *            the array to be copyProcess
     * @param newLength
     *            the length of the copyFile to be returned
     * @return a copyFile of the original array, truncated or padded with zeros to
