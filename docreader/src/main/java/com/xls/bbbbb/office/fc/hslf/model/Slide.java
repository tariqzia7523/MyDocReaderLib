...
import com.xls.bbbbb.office.fc.hslf.record.ColorSchemeAtom;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.xls.bbbbb.office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new com.xls.bbbbb.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see com.xls.bbbbb.office.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.xls.bbbbb.office.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.xls.bbbbb.office.fc.hslf.record.Slide)getSheetContainer();
    }
