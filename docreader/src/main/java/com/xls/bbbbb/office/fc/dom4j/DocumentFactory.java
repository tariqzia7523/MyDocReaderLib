...
import com.xls.bbbbb.office.fc.dom4j.tree.AbstractDocument;
import com.xls.bbbbb.office.fc.dom4j.tree.DefaultAttribute;
import com.xls.bbbbb.office.fc.dom4j.tree.DefaultCDATA;
import com.xls.bbbbb.office.fc.dom4j.tree.DefaultComment;
...
import com.xls.bbbbb.office.fc.dom4j.tree.DefaultEntity;
import com.xls.bbbbb.office.fc.dom4j.tree.DefaultProcessingInstruction;
import com.xls.bbbbb.office.fc.dom4j.tree.DefaultText;
import com.xls.bbbbb.office.fc.dom4j.tree.QNameCache;
import com.xls.bbbbb.office.fc.dom4j.util.SimpleSingleton;
import com.xls.bbbbb.office.fc.dom4j.util.SingletonStrategy;
import com.xls.bbbbb.office.fc.dom4j.xpath.DefaultXPath;
import com.xls.bbbbb.office.fc.dom4j.xpath.XPathPattern;
...
public class DocumentFactory implements Serializable
{
    ...
    private static SingletonStrategy createSingleton()
    {
        ...
        try
        {
            documentFactoryClassName = System.getProperty("com.xls.bbbbb.office.fc.dom4j.factory",
                "com.xls.bbbbb.office.fc.dom4j.DocumentFactory");
        }
        catch(Exception e)
        {
            documentFactoryClassName = "com.xls.bbbbb.office.fc.dom4j.DocumentFactory";
        }

        try
        {
            String singletonClass = System.getProperty(
                "com.xls.bbbbb.office.fc.dom4j.DocumentFactory.singleton.strategy", "com.xls.bbbbb.office.fc.dom4j.util.SimpleSingleton");
