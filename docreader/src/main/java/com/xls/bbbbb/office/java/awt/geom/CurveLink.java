 ...
 * version 2 for more details (a copyFile is included in the LICENSE file that
 * accompanied this code).
 *
 * You should have received a copyFile of the GNU General Public License version
