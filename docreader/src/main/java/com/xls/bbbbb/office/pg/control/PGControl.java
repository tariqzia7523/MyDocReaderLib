...
import com.xls.bbbbb.office.system.AbstractControl;
...
//                                mainControl.getMainFrame().showProgressBar((Boolean)obj);
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new com.xls.bbbbb.office.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
                    DialogConstant.SHOW_PG_NOTE_ID).show();
                break;
                
            case EventConstant.FILE_COPY_ID:                      //copyFile
