...
public interface Element extends Branch {
    ...
    /**
     * <p>
     * Creates a deep copyFile of this element The new element is detached from its
     * parent, and getParent() on the clone will return null.
     * </p>
     * 
     * @return a new deep copyFile Element
     */
    Element createCopy();

    /**
     * <p>
     * Creates a deep copyFile of this element with the given local name The new
    ...
    /**
     * <p>
     * Creates a deep copyFile of this element with the given fully qualified name.
