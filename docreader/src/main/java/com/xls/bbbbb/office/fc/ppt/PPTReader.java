 ...
 * 时间:               下午4:23:51
 */
package com.xls.bbbbb.office.fc.ppt;
...
import com.xls.bbbbb.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.xls.bbbbb.office.common.bg.BackgroundAndFill;
import com.xls.bbbbb.office.common.bg.Gradient;
import com.xls.bbbbb.office.common.bg.LinearGradientShader;
import com.xls.bbbbb.office.common.bg.RadialGradientShader;
import com.xls.bbbbb.office.common.bg.TileShader;
import com.xls.bbbbb.office.common.hyperlink.Hyperlink;
import com.xls.bbbbb.office.common.pictureefftect.PictureEffectInfoFactory;
import com.xls.bbbbb.office.common.shape.AbstractShape;
import com.xls.bbbbb.office.common.shape.ArbitraryPolygonShape;
import com.xls.bbbbb.office.common.shape.Arrow;
import com.xls.bbbbb.office.common.shape.AutoShape;
import com.xls.bbbbb.office.common.shape.GroupShape;
import com.xls.bbbbb.office.common.shape.IShape;
import com.xls.bbbbb.office.common.shape.LineShape;
import com.xls.bbbbb.office.common.shape.PictureShape;
import com.xls.bbbbb.office.common.shape.ShapeTypes;
import com.xls.bbbbb.office.common.shape.TableCell;
import com.xls.bbbbb.office.common.shape.TableShape;
import com.xls.bbbbb.office.common.shape.TextBox;
import com.xls.bbbbb.office.constant.AutoShapeConstant;
import com.xls.bbbbb.office.constant.EventConstant;
import com.xls.bbbbb.office.constant.MainConstant;
import com.xls.bbbbb.office.constant.wp.WPAttrConstant;
import com.xls.bbbbb.office.constant.wp.WPModelConstant;
import com.xls.bbbbb.office.fc.FCKit;
import com.xls.bbbbb.office.fc.ShapeKit;
import com.xls.bbbbb.office.fc.hslf.HSLFSlideShow;
import com.xls.bbbbb.office.fc.hslf.model.Fill;
import com.xls.bbbbb.office.fc.hslf.model.HeadersFooters;
import com.xls.bbbbb.office.fc.hslf.model.Line;
import com.xls.bbbbb.office.fc.hslf.model.MasterSheet;
import com.xls.bbbbb.office.fc.hslf.model.Notes;
import com.xls.bbbbb.office.fc.hslf.model.Shape;
import com.xls.bbbbb.office.fc.hslf.model.ShapeGroup;
import com.xls.bbbbb.office.fc.hslf.model.Sheet;
import com.xls.bbbbb.office.fc.hslf.model.SimpleShape;
import com.xls.bbbbb.office.fc.hslf.model.Slide;
import com.xls.bbbbb.office.fc.hslf.model.SlideMaster;
import com.xls.bbbbb.office.fc.hslf.model.TextShape;
import com.xls.bbbbb.office.fc.hslf.model.TitleMaster;
import com.xls.bbbbb.office.fc.hslf.record.BinaryTagDataBlob;
import com.xls.bbbbb.office.fc.hslf.record.ClientVisualElementContainer;
import com.xls.bbbbb.office.fc.hslf.record.DocumentAtom;
import com.xls.bbbbb.office.fc.hslf.record.OEPlaceholderAtom;
import com.xls.bbbbb.office.fc.hslf.record.PositionDependentRecordContainer;
import com.xls.bbbbb.office.fc.hslf.record.Record;
import com.xls.bbbbb.office.fc.hslf.record.SlideAtom;
import com.xls.bbbbb.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.xls.bbbbb.office.fc.hslf.record.SlideProgBinaryTagContainer;
import com.xls.bbbbb.office.fc.hslf.record.SlideProgTagsContainer;
import com.xls.bbbbb.office.fc.hslf.record.SlideShowSlideInfoAtom;
import com.xls.bbbbb.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeNodeContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.xls.bbbbb.office.fc.hslf.record.TimeVariant;
import com.xls.bbbbb.office.fc.hslf.record.VisualShapeAtom;
import com.xls.bbbbb.office.fc.hslf.usermodel.PictureData;
import com.xls.bbbbb.office.fc.hslf.usermodel.RichTextRun;
import com.xls.bbbbb.office.fc.hslf.usermodel.SlideShow;
import com.xls.bbbbb.office.fc.ppt.bulletnumber.BulletNumberManage;
...
import com.xls.bbbbb.office.pg.animate.ShapeAnimation;
import com.xls.bbbbb.office.pg.model.PGModel;
import com.xls.bbbbb.office.pg.model.PGNotes;
import com.xls.bbbbb.office.pg.model.PGSlide;
import com.xls.bbbbb.office.simpletext.font.FontTypefaceManage;
import com.xls.bbbbb.office.simpletext.model.AttrManage;
import com.xls.bbbbb.office.simpletext.model.IAttributeSet;
import com.xls.bbbbb.office.simpletext.model.LeafElement;
import com.xls.bbbbb.office.simpletext.model.ParagraphElement;
import com.xls.bbbbb.office.simpletext.model.SectionElement;
import com.xls.bbbbb.office.ss.util.format.NumericFormatter;
import com.xls.bbbbb.office.system.AbstractReader;
import com.xls.bbbbb.office.system.BackReaderThread;
...
{   
    ...
    private com.xls.bbbbb.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.xls.bbbbb.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.xls.bbbbb.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.xls.bbbbb.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.xls.bbbbb.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.xls.bbbbb.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.xls.bbbbb.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.xls.bbbbb.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.xls.bbbbb.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.xls.bbbbb.office.fc.hslf.model.Freeform
            || shape instanceof com.xls.bbbbb.office.fc.hslf.model.AutoShape
            || shape instanceof com.xls.bbbbb.office.fc.hslf.model.TextBox
            || shape instanceof com.xls.bbbbb.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.xls.bbbbb.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.xls.bbbbb.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.xls.bbbbb.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.xls.bbbbb.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.xls.bbbbb.office.fc.hslf.model.AutoShape
                    || shape instanceof com.xls.bbbbb.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.xls.bbbbb.office.fc.hslf.model.Picture)
            {   
                com.xls.bbbbb.office.fc.hslf.model.Picture poiPic = (com.xls.bbbbb.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.xls.bbbbb.office.fc.hslf.model.Table)
        {
            com.xls.bbbbb.office.fc.hslf.model.Table poiTable = (com.xls.bbbbb.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.xls.bbbbb.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.xls.bbbbb.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.xls.bbbbb.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.xls.bbbbb.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.xls.bbbbb.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.xls.bbbbb.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.xls.bbbbb.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.xls.bbbbb.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.xls.bbbbb.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
