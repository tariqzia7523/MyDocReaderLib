...
import com.xls.bbbbb.office.fc.hslf.model.Hyperlink;
import com.xls.bbbbb.office.fc.hslf.model.MovieShape;
...
import com.xls.bbbbb.office.fc.hslf.record.ExAviMovie;
import com.xls.bbbbb.office.fc.hslf.record.ExControl;
import com.xls.bbbbb.office.fc.hslf.record.ExHyperlink;
import com.xls.bbbbb.office.fc.hslf.record.ExHyperlinkAtom;
import com.xls.bbbbb.office.fc.hslf.record.ExMCIMovie;
import com.xls.bbbbb.office.fc.hslf.record.ExObjList;
import com.xls.bbbbb.office.fc.hslf.record.ExObjListAtom;
import com.xls.bbbbb.office.fc.hslf.record.ExOleObjAtom;
import com.xls.bbbbb.office.fc.hslf.record.ExVideoContainer;
import com.xls.bbbbb.office.fc.hslf.record.ExtendedParagraphHeaderAtom;
import com.xls.bbbbb.office.fc.hslf.record.ExtendedPresRuleContainer;
import com.xls.bbbbb.office.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import com.xls.bbbbb.office.fc.hslf.record.FontCollection;
import com.xls.bbbbb.office.fc.hslf.record.HeadersFootersContainer;
import com.xls.bbbbb.office.fc.hslf.record.PersistPtrHolder;
import com.xls.bbbbb.office.fc.hslf.record.PositionDependentRecord;
...
import com.xls.bbbbb.office.fc.hslf.record.SlideListWithText;
import com.xls.bbbbb.office.fc.hslf.record.SlideListWithText.SlideAtomsSet;
import com.xls.bbbbb.office.fc.hslf.record.SlidePersistAtom;
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof com.xls.bbbbb.office.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((com.xls.bbbbb.office.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof com.xls.bbbbb.office.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((com.xls.bbbbb.office.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
        com.xls.bbbbb.office.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new com.xls.bbbbb.office.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<com.xls.bbbbb.office.fc.hslf.record.Notes> notesRecordsL = new ArrayList<com.xls.bbbbb.office.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                ...
                if (r instanceof com.xls.bbbbb.office.fc.hslf.record.Notes)
                {
                    com.xls.bbbbb.office.fc.hslf.record.Notes notesRecord = (com.xls.bbbbb.office.fc.hslf.record.Notes)r;
            ...
            notesRecords = new com.xls.bbbbb.office.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
        com.xls.bbbbb.office.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new com.xls.bbbbb.office.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new com.xls.bbbbb.office.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof com.xls.bbbbb.office.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (com.xls.bbbbb.office.fc.hslf.record.Slide)r;
                }
                /*else
                {
