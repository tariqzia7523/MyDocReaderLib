...
import com.xls.bbbbb.office.fc.ss.usermodel.IFont;
...
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.xls.bbbbb.office.fc.ss.usermodel.Workbook workbook) {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.xls.bbbbb.office.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     *  copyFile styles from one HSSFWorkbook to another.
     */
