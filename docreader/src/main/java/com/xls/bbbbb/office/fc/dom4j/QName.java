...
public class QName implements Serializable
{
    ...
    static
    {
        try
        {
            String defaultSingletonClass = "com.xls.bbbbb.fc.dom4j.util.SimpleSingleton";
            Class clazz = null;
            try
            {
                String singletonClass = defaultSingletonClass;
                singletonClass = System.getProperty("com.xls.bbbbb.fc.dom4j.QName.singleton.strategy",
                    singletonClass);
