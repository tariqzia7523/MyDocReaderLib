...
package com.xls.bbbbb.office.fc.doc;
...
import com.xls.bbbbb.office.common.bookmark.Bookmark;
...
import com.xls.bbbbb.office.common.bulletnumber.ListData;
import com.xls.bbbbb.office.common.bulletnumber.ListLevel;
...
import com.xls.bbbbb.office.common.shape.WPAbstractShape;
import com.xls.bbbbb.office.common.shape.WPAutoShape;
import com.xls.bbbbb.office.common.shape.WPGroupShape;
import com.xls.bbbbb.office.common.shape.WPPictureShape;
...
import com.xls.bbbbb.office.fc.ddf.EscherTextboxRecord;
...
import com.xls.bbbbb.office.fc.hwpf.model.POIListData;
import com.xls.bbbbb.office.fc.hwpf.model.POIListLevel;
import com.xls.bbbbb.office.fc.hwpf.model.PicturesTable;
import com.xls.bbbbb.office.fc.hwpf.usermodel.Bookmarks;
import com.xls.bbbbb.office.fc.hwpf.usermodel.BorderCode;
import com.xls.bbbbb.office.fc.hwpf.usermodel.CharacterRun;
import com.xls.bbbbb.office.fc.hwpf.usermodel.Field;
import com.xls.bbbbb.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.xls.bbbbb.office.fc.hwpf.usermodel.HWPFShape;
import com.xls.bbbbb.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.xls.bbbbb.office.fc.hwpf.usermodel.HeaderStories;
import com.xls.bbbbb.office.fc.hwpf.usermodel.InlineWordArt;
import com.xls.bbbbb.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.xls.bbbbb.office.fc.hwpf.usermodel.OfficeDrawing;
import com.xls.bbbbb.office.fc.hwpf.usermodel.OfficeDrawings;
import com.xls.bbbbb.office.fc.hwpf.usermodel.POIBookmark;
import com.xls.bbbbb.office.fc.hwpf.usermodel.Paragraph;
import com.xls.bbbbb.office.fc.hwpf.usermodel.PictureType;
import com.xls.bbbbb.office.fc.hwpf.usermodel.Range;
import com.xls.bbbbb.office.fc.hwpf.usermodel.Section;
import com.xls.bbbbb.office.fc.hwpf.usermodel.Table;
import com.xls.bbbbb.office.fc.hwpf.usermodel.TableCell;
import com.xls.bbbbb.office.fc.hwpf.usermodel.TableRow;
import com.xls.bbbbb.office.fc.util.LittleEndian;
import com.xls.bbbbb.office.java.awt.Rectangle;
import com.xls.bbbbb.office.java.util.Arrays;
...
import com.xls.bbbbb.office.simpletext.view.PageAttr;
import com.xls.bbbbb.office.ss.util.ModelUtil;
...
import com.xls.bbbbb.office.wp.model.HFElement;
import com.xls.bbbbb.office.wp.model.RowElement;
import com.xls.bbbbb.office.wp.model.TableElement;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.xls.bbbbb.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.xls.bbbbb.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.xls.bbbbb.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.xls.bbbbb.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
